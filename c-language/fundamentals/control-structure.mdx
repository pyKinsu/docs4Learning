...
<img src="/images/control-structure-tree.svg" alt="Control Structure diagram showing three branches: Decision-Making (if, if-else, switch-case), Looping (for, while, do-while), and Jumping (break, continue, goto, return)" />
