...
|---|---|---|---|
| No argument, no return | None | None | `void greet()` |
| No argument, with return | None | Yes | `int getYear()` |
| With argument, no return | Yes | None | `void display(int x)` |
| With argument, with return | Yes | Yes | `int add(int a, int b)` |
