...
| **Value preservation** | All members hold their values simultaneously | Only the **last-written** member is valid |
| **Access** | Multiple members accessible at once | Only one member valid at a time |
| **Initialization** | Multiple members can be initialized | Only the **first** member can be initialized |
