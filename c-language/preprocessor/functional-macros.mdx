...
| Speed | Faster (inline expansion) | Slight overhead (call/return) |
| Debugging | Harder | Easier |
| Code bloat | More (expands everywhere) | Less (single definition) |
| Side effects | Possible (args evaluated multiple times) | None |
